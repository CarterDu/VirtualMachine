...
public class Computer {
	...
	private Longword statusOfCompare = new Longword();
	...
	public void execute() throws Exception{
		 ...
		 */
			...
			statusOfCompare = RippleAdder.subtract(op1, op2);
		}
	...
	public void preload(String[] instructions){
		...
		Longword[] lwArr = new Longword[instructions.length / 2];	//combine 2 instructions to a longword which will be written to memory
